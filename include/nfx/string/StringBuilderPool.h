...
namespace nfx::string
{
	...
	private:
		...
		NFX_CORE_INLINE explicit StringBuilder( DynamicStringBuffer& buffer );
	...
	public:
		 ...
		 */
		NFX_CORE_INLINE char& operator[]( size_t index );
		 ...
		 */
		NFX_CORE_INLINE const char& operator[]( size_t index ) const;
		 ...
		 * @param str String view to append
		 */
		NFX_CORE_INLINE void append( std::string_view str );

		/**
		 * @brief Appends std::string contents to the buffer
		 * @param str String to append
		 */
		NFX_CORE_INLINE void append( const std::string& str );
		 ...
		 */
		NFX_CORE_INLINE void append( const char* str );

		/**
		 * @brief Appends single character to the buffer
		 * @param c Character to append
		 */
		NFX_CORE_INLINE void push_back( char c );
		 ...
		 */
		NFX_CORE_INLINE StringBuilder& operator<<( std::string_view str );
		 ...
		 * @return Reference to this StringBuilder for chaining
		 */
		NFX_CORE_INLINE StringBuilder& operator<<( const std::string& str );
		 ...
		 * @return Reference to this StringBuilder for chaining
		 */
		NFX_CORE_INLINE StringBuilder& operator<<( const char* str );
		 ...
		 * @return Reference to this StringBuilder for chaining
		 */
		NFX_CORE_INLINE StringBuilder& operator<<( char c );
		 ...
		 */
		NFX_CORE_INLINE void resize( size_t newSize );
		...
		public:
			 ...
			 */
			NFX_CORE_INLINE Enumerator( const StringBuilder& builder );
	...
	private:
		...
		NFX_CORE_INLINE explicit StringBuilderLease( DynamicStringBuffer* buffer );
